...
\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000013}{Todo}]Improve this so that no new arrays have to be created. \end{DoxyRefDesc}
...
\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000012}{Todo}]Improve this so that no extra arrays have to be created. \end{DoxyRefDesc}
