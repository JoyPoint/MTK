...
\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000016}{Todo}]Improve this so that no new arrays have to be created. \end{DoxyRefDesc}
...
\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000015}{Todo}]Improve this so that no extra arrays have to be created. \end{DoxyRefDesc}
