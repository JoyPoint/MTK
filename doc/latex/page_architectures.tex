...
In this page we intend to make a summary of all of the architectures in where the M\+T\+K has been tested. The M\+T\+K is intended to be as portable as possible throughout architectures. The following architectures have provided flawless installations of the A\+P\+I and correct execution of the tests and the examples\+:

\begin{DoxyVerb}1. Intel(R) Pentium(R) M CPU 1.73 GHz 2048 KB of cache and stepping of 8.
