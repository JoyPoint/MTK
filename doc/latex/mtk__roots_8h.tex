...
\item[\hyperlink{todo__todo000006}{Todo}]Documentation should (better?) capture effects from selective compilation.\end{DoxyRefDesc}


\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000007}{Todo}]Test selective precision mechanism. \end{DoxyRefDesc}
