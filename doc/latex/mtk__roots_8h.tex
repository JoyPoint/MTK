...
\item[\hyperlink{todo__todo000005}{Todo}]Documentation should (better?) capture effects from selective compilation.\end{DoxyRefDesc}


\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000006}{Todo}]Test selective precision mechanisms. \end{DoxyRefDesc}
